...
broseButton_PNG= tk.Button(text="   Import PNG File    ", command=getPNG, bg="royalblue", fg="white", font=("helvetica",12,"bold"))
canvas1.create_window(150,130,window= broseButton_PNG)
